...
from db_functions import fn_insert_personal_data, fn_load_json, fn_insert_experiences, fn_insert_hard_skills, fn_insert_formation
...
formation = fn_load_json('src_data/formation.json')
...
fn_insert_formation(formation, engine)
